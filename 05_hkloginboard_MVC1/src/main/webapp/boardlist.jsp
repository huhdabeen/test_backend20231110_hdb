...
<meta charset="UTF-8">
<title>글목록조회</title>
<link rel="stylesheet" href="css/layout_001.css" />
		...
		<table border="1">
			...
			<%
				for(int i=0; i<list.size(); i++){
					...
					<tr>
						...
						<td><%=dto.getSeq()%></td>
						<td><%=dto.getId()%></td>
						<td><a href="boardController.jsp?command=detailBoard&seq=<%=dto.getSeq()%>"><%=dto.getTitle()%></a></td>
			...
			<tr>
				<td colspan="5">
					...
					<input style="border-radius: 5px; text-align: left;" type="submit" value="삭제"/>	
				</td>
			</tr>
		</table>
		</form>
